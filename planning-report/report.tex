...
every bit of distance information about every point. To give an example, consider a
fisherman who is not in possession of a sonar to tell him the distance between every fish
in the lake he is fishing at; he can still have a notion of nearness by observing what kinds
of fish are caught in consecutive casts of his rod\footnote{I thank Adam Bj\"{o}rndahl
from CMU for this vivid analogy.}.
...
seems to work well for the purpose implementing locale theory in type theory.

The goal of this thesis will be to carry out a development of pointless topology in type
theory as well paying special attention to the presentation method. The main contribution
...
question of \emph{what locales mean and behave like in univalent foundations}. It is in
general well-known that univalent foundations tend to be more conducive to conducting
