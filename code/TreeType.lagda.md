...
ψ-lemma 𝒯@(D , D-sim) U V a₀ a₁ a₂ a₂⊑a₀ a₂⊑a₁ (Leaf   a₀   , p) (Branch b₁ g , q) = Branch b₂ h , NTS
  where
    open PosetStr (proj₂ (pos D)) using (⊑-refl; _⊑⟨_⟩_; _■)
    ...
    h o₂ = NTS
      where
        o₁ : outcome D b₁
        o₁ = proj₁ (proj₂ (D-sim a₁ a₂ a₂⊑a₁ b₁) (revise D o₂) (o₂ , ⊑-refl (revise D o₂)))

        t₁′ : experiment⋆ D (revise D o₁)
        t₁′ = g o₁

        NTS : experiment⋆ D (revise D o₂)
        NTS = proj₁ (sim⇒sim⋆ D D-sim (revise D o₁) (revise D o₂) rev-o₂⊑rev-o₁ t₁′)
          where
            rev-o₂⊑rev-o₁ : revise D o₂ ⊑[ pos D ] revise D o₁ holds
            rev-o₂⊑rev-o₁ = proj₂ (proj₂ (D-sim a₁ a₂ a₂⊑a₁ b₁) (revise D o₂) (o₂ , (⊑-refl (revise D o₂))))

    NTS : (a : ∣ pos D ∣ₚ) → a ≤[ pos D ] leaves (Branch b₂ h) → (U ∩ V) a holds
    NTS a (os@(o₂ , os₂) , a⊑leaves-t₂-os) = {!!} , q a 𝔊₁
      where
        o₁ : outcome D b₁
        o₁ = proj₁ (proj₂ (D-sim a₁ a₂ a₂⊑a₁ b₁) (revise D o₂) (o₂ , (⊑-refl (revise D o₂))))
        ...
        𝔊₁ : Σ[ o ∈ (outcome⋆ {D = D} (Branch b₁ g)) ] a ⊑[ pos D ] ((leaves (Branch b₁ g)) € o) holds
        𝔊₁ = (o₁  , os₁) , {!!}

ψ-lemma 𝒯 U V a₀ a₁ a₂ a₂⊑a₀ a₂⊑a₁ (Branch b₀ f , p) (Leaf   a₁   , q) = {!!}

ψ-lemma 𝒯 U V a₀ a₁ a₂ a₂⊑a₀ a₂⊑a₁ (Branch b₀ f , p) (Branch b₁ g , q) = {!!}
