...
whose index types live in the $\univ{}_0$; this would be sufficient for entertaining only
trivial examples of topologies.
...
\begin{defn}\label{defn:frame-iso-official}
  An isomorphism between fames $F$ and $G$ is simply an isomorphism of their underlying
  posets.
\end{defn}
...
\end{prop}
\begin{proof}[Proof sketch]
  Usin Prop.~\ref{prop:family-iff}, apply the distributivity law, use
