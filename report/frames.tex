...
\begin{defn}[Frame]\label{defn:frame}
  ...
  \begin{alignat*}{2}
    ...
    \mathsf{isLUB}\left(\bigvee\right) \quad&\is\quad
         &&\pity{U}{\sub{n}{A}}{\pity{x}{A}{\memfam{x}{U} \rightarrow x \sqsubseteq \bigvee_i U_i}}\\
         &\hspace{0.55em}\times &&\pity{U}{\sub{n}{A}}{\pity{x}{A}{
...
\subsection{Some properties of frames}
