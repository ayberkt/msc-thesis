...
Escardó~\cite{synthetic-topology}, etc (TODO), and most saliently, Vickers~\cite{vickers}.
...
one $0$ and $1$. Let us summarise this definition in the form of an informal definition:
\begin{quote}
  An observable property is a property such that if it holds, this can be observed by a
  finite amount of evidence.
\end{quote}
