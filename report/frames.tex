...
\begin{defn}[Frame]\label{defn:frame}
  ...
  \begin{align*}
    ...
    \mathsf{IsLUB}\left(\bigvee\right) \quad&\is\quad
         \pity{F}{\sub{n}{A}}{\pity{x}{A}{x \epsilon F \rightarrow x \sqsubseteq \bigvee_{i~:~\indexset{F}} F_i}}\\
         &\hspace{0.7em}\times \pity{F}{\sub{n}{A}}{\pity{x}{A}{
               \left( \pity{y}{A}{y \epsilon F \rightarrow x \sqsubseteq y}\right) \rightarrow \left( \bigvee_{i~:~\indexset{F}} F \right) \sqsubseteq x
             }}
  \end{align*}
\end{defn}
