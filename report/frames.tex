...
\todo{
  First introduce the structure identity principle and make use of that to prove this
  result. In the formalisation, the SIP from the \texttt{cubical} library is used.
  Accordingly, I can provide a high-level yet detailed overview of the SIP and remark
  that frames, as they have been defined here, form a standard notion of structure hence
  admitting the SIP. Going into all the technical details seems to be neither necessary
  nor desirable in terms of presentation.
}\vspace{\baselineskip}
