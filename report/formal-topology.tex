...
\begin{defn}[$\eta$]
  Let $\McF{}$ be a formal topology with underlying poset $P$ and cover relation
  $\covers{\_}{\_}$. Let $L \is \fix{\dcsubset{A}}{\_\RHD\_}$. There exists a monotonic
  map from $P$ to $\fix{\dcframe{P}}{\covernm{}}$, defined as:
  \begin{align*}
