...
preserves these finite meets but we cannot mention the meets of $P$ as they do not exist.
So we instead require $f$ to preserve those meets that \emph{do not exist yet} which we
can do by requiring the following conditions:
\begin{enumerate}
