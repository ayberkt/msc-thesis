...
\begin{proof}[Proof of Theorem~\ref{thm:univ-prop}]
  ...
  \begin{align*}
    g(U \cap V) &\equiv \bigvee^R \{ f(a) ~|~ a \in U \cap V \} \\
             ...
             &\equiv g(U) \wedge g(V)                                                         .
  \end{align*}
  Let us now show that $g$ respects joins. Let $U$ be a family of inhabitants of
  $\abs{L}$.
  \begin{align*}
    g(\bigvee^L_i U_i) &\equiv \bigvee^R \setof{ f(a) ~|~ a \in \bigvee^L_i U_i } \\
         &= ...                                          &&\text{[Lemma~\ref{lem:flatten}]} \\
         &= \bigvee^R \setof{ \bigvee^L \img{f}{U_i} ~|~ U_i \in U } \\
         &\equiv \bigvee^R_i g(U_i)
  \end{align*}
