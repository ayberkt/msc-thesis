...
notion of a formal topology is that it admits a coverage relation. This method goes back
to Johnstone's~\cite{stone-spaces} adaptation of the notion of a Grothendieck topology.
