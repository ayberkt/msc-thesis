...
importantly, this would allow us to attempt to prove that two frames satisfying the
universal property are isomorphic. As we proved that isomorphic frames are equal, this
would mean two such frames are \emph{equal}.
