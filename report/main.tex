...
\newcommand{\mono}[2]{#1 \hyperref[defn:mono-map]{\rightarrow_m} #2}

\newcommand{\isframehomonm}{\hyperref[defn:frame-homo]{\mathsf{isFrameHomo}}}
\newcommand{\isframehomo}[1]{\isframehomonm{}\left(#1\right)}

\newcommand{\framehomonm}{\hyperref[defn:frame-homo]{\mathsf{FrameHomo}}}
\newcommand{\framehomo}[2]{\framehomonm{}\left(#1, #2\right)}
